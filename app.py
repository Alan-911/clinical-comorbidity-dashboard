...
/* Modal overlays: <div>-based, moved to document.body at click time to escape stacking context. */
.cd-ov{display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(15,23,42,0.65);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);z-index:2147483647;align-items:center;justify-content:center;animation:dlgIn 0.18s ease-out;}
.cd-ov.show{display:flex;}
.cd-mo{background:#fff;border-radius:20px;padding:32px;width:90%;max-width:720px;position:relative;box-shadow:0 30px 80px rgba(0,0,0,0.25);max-height:85vh;overflow-y:auto;color:#0f172a;font-family:'Inter',-apple-system,sans-serif;}
...
<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 36px;background:rgba(255,255,255,0.75);backdrop-filter:blur(15px);-webkit-backdrop-filter:blur(15px);border-radius:100px;box-shadow:0 4px 20px rgba(0,0,0,0.05);margin-bottom:18px;position:relative;z-index:10;">
  ...
  <div style="display:flex;gap:20px;font-size:13px;font-weight:600;color:#64748b;">
    <span onclick="var m=document.getElementById('dashModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" style="cursor:pointer;transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#64748b'">Dashboard</span>
    <span onclick="var m=document.getElementById('apptModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" style="cursor:pointer;transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#64748b'">Appointments</span>
    <span onclick="var m=document.getElementById('schedModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" style="cursor:pointer;transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#64748b'">Schedule</span>
    <span onclick="var m=document.getElementById('labsModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" style="cursor:pointer;transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#64748b'">Labs</span>
  </div>
  <div onclick="var m=document.getElementById('patientModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" style="text-align:right;cursor:pointer;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'"><div style="font-size:10px;font-weight:800;">PATIENT #2440</div><div style="font-size:9px;color:#3b82f6;">&#9679; CONNECTED</div></div>
</div>
...
<div style="display:grid;grid-template-columns:1fr 1.3fr 1.6fr;gap:22px;position:relative;z-index:2;">
  <div>
    ...
    {plan_html}
    <div onclick="var m=document.getElementById('demoModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" class="gc" style="cursor:pointer;text-align:center;padding:14px;" onmouseover="this.style.boxShadow='0 10px 30px rgba(59,130,246,0.15)'" onmouseout="this.style.boxShadow='0 10px 30px rgba(0,0,0,0.07)'"><h3 style="margin:0;font-size:14px;">Demographic Comorbidity Patterns</h3></div>
    <div onclick="var m=document.getElementById('advisoryModal');if(m.parentNode!==document.body)document.body.appendChild(m);m.classList.add('show');" class="gc" style="border-left:4px solid #3b82f6;cursor:pointer;" onmouseover="this.style.boxShadow='0 10px 30px rgba(59,130,246,0.15)'" onmouseout="this.style.boxShadow='0 10px 30px rgba(0,0,0,0.07)'">
...
<!-- MODALS -->
<div id="dashModal" class="cd-ov" onclick="if(event.target===this)this.classList.remove('show')"><div class="cd-mo" style="width:680px;"><button onclick="this.closest('.cd-ov').classList.remove('show')" class="cd-cl">&#10005;</button>
...
<div id="patientModal" class="cd-ov" onclick="if(event.target===this)this.classList.remove('show')"><div class="cd-mo" style="width:560px;"><button onclick="this.closest('.cd-ov').classList.remove('show')" class="cd-cl">&#10005;</button>
